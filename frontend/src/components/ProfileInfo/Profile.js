...
function Profile() {
  ...
  const getUserData = async () => {
	...
	console.log("name: " + education.School1.name)
  };
  ...
  <h5>Education</h5>
  <hr></hr>
  {user.education && Object.entries(education).map(([key, school]) => (
  <React.Fragment key={key}>
    ...
    {Object.keys(user.education).indexOf(key) !== Object.keys(user.education).length - 1 && <hr />}
  </React.Fragment>
))}
